...
const SeasonFormPage: React.FC = () => {
  ...
  const [editingSeason, setEditingSeason] = useState<MasterDataItem | null>(null);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingSeason) {
        await seasonService.update(editingSeason._id!, seasonData);
      } else {
  ...
  const handleEdit = (season: MasterDataItem) => {
