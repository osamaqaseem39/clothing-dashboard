...
const ProductFormInventory: React.FC<ProductFormInventoryProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
        <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
          <h2 className="text-lg font-semibold text-gray-900">Model Measurements</h2>
          <p className="mt-1 text-sm text-gray-600">
            Reference measurements for size guidance and customer information
          </p>
        </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-2">Chest</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-2">Waist</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-2">Hips</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-2">Size Wearing</label>
              <input
                type="text"
